...
__C.HIST_EQ_SYM = False
__C.A_HIST_EQ = False

# For deeplesion dataset. This parameter is used on 'https://github.com/rsummers11/CADLab/tree/master/lesion_detector_3DCE' 
__C.WINDOWING = [-1024, 3071]

# ---------------------------------------------------------------------------- #
# DeepLesion options
# ---------------------------------------------------------------------------- #
__C.LESION = AttrDict()
__C.LESION.USE_3DCE_FROC = True

# For 2D network, whether use three slices or a single slices without normalization
#__C.LESION.THREE_SLICES = False
#__C.LESION.USE_NORMED_CT = False

__C.LESION.SLICE_INTERVAL = 2.0
__C.LESION.LESION_ENABLED = False

# For 3D DeepLesion Input
__C.LESION.USE_3D_INPUT = False
__C.LESION.SLICE_NUM = 3
__C.LESION.NO_DEPTH_PAD = True
__C.LESION.DEBUG = False

# For 3DCE architecture
__C.LESION.USE_3DCE = False
# Symbol M in the paper,can be 1,3,5,7,9...
__C.LESION.NUM_IMAGES_3DCE = 1

__C.LESION.MULTI_MODALITY = False
# For multi modality,concat blobs before RPN
__C.LESION.CONCAT_BEFORE_RPN = False
# For multi modality,sum blobs before RPN
__C.LESION.SUM_BEFORE_RPN = False
__C.LESION.GIF_BEFORE_RPN = False
__C.LESION.FUSION_BEFORE_RPN = False
__C.LESION.WITHOUT_SHARE = False

# For Position supervise
__C.LESION.USE_POSITION = False
__C.LESION.SHALLOW_POSITION = False
__C.LESION.POSITION_RCNN = False
__C.LESION.MM_POS= False
__C.LESION.MM_POS_CHANNEL= False
__C.LESION.POS_CONCAT_RCNN= False
# Using specific window for each sample
__C.LESION.USE_SPECIFIC_WINDOWS = False
# Only use samples with maximum num of same window (-175,275)
__C.LESION.USE_ONE_WINDOW = False

# Multi modality input
__C.LESION.USE_MULTI_WINDOWS = False
# Added for implementing multi-context roi-pooling RCNN
__C.LESION.MM_TEST= False

__C.CONTEXT_ROI_POOLING = AttrDict()
__C.CONTEXT_ROI_POOLING.ENABLED = False
# Indicate how to merge different feature maps of different scales, support concat and sum
__C.CONTEXT_ROI_POOLING.MERGE_TYPE = 'concat'
# Set to true to use the merged features for both cls and reg, otherwise, use them for cls purpose only
__C.CONTEXT_ROI_POOLING.SHARE_FEATURE = False
# Set zoom_ratio to values smaller than 0 to use the whole image as global context
__C.CONTEXT_ROI_POOLING.ZOOM_RATIO = 1.5


# Added for implementing context-contrasted features after the blob_convs

__C.CONTRASTED_CONTEXT = AttrDict()
__C.CONTRASTED_CONTEXT.ENABLED = False
__C.CONTRASTED_CONTEXT.DILATION_SIZE = 5
...
__C.TRAIN.VIS_ANCHOR_DIR = './anchor_vis/'
__C.TRAIN.VIS_ANCHOR = False
# Set to True to randomly perturb the bbox of other images during training
__C.TRAIN.AUG_LRV_BBOX = False
# Set to True to use normlized window data
__C.TRAIN.NORM_DATA = False
__C.TRAIN.AUGMENTATION = False
# 
__C.TRAIN.PADDING = 128
__C.TRAIN.IGNORE_ON = False
...
# Use z_axis-flipped images during training?
__C.TRAIN.USE_Z_FLIPPED = False
__C.TRAIN.USE_ADJACENT_LAYER = False
...
__C.TRAIN.ONLINE_RANDOM_CROPPING = False
# probability of whether to crop or not
__C.TRAIN.ONLINE_RANDOM_CROPPING_PROBABILITY = 1.0
# threshold of iop, to keep the truncated mass
__C.TRAIN.ONLINE_RANDOM_CROPPING_IOP_THRESHOLD = 0.9
# range of cropped bounding box
__C.TRAIN.ONLINE_RANDOM_CROPPING_HEIGHT_MIN = 500
__C.TRAIN.ONLINE_RANDOM_CROPPING_HEIGHT_MAX = 2000
__C.TRAIN.ONLINE_RANDOM_CROPPING_WIDTH_MIN = 500
__C.TRAIN.ONLINE_RANDOM_CROPPING_WIDTH_MAX = 1000
...
# whether use Focal Loss for RPN and RCNN
__C.TRAIN.FOCAL_LOSS = False
__C.TRAIN.RCNN_FOCAL_LOSS = False
...
# Whether save gts and preds to .txt file for further implementation
__C.TEST.OFFLINE_MAP = True
...
# Whether evaluate mask results
__C.TEST.MASK = False
# Whether use mask bounded bbox for bbox eva
__C.TEST.MAM_MASK_BBOX = False
# Whether only visulaize inference results
__C.TEST.VIS_TEST_ONLY = False
# For lung_det and deeplession, only visualize the central slice
__C.TEST.VIS_SINGLE_SLICE = False
...
# For double side input model, use either the GIF module or the LR_VIEW module
# Could not be True at the same time
__C.MODEL.LR_VIEW_ON = False
__C.MODEL.GIF_ON = False
__C.MODEL.LRASY_MAHA_ON = False
...
# whether load affine2dtransform param or BatchNorm2d param.
__C.MODEL.LOADAFFINE = True
...
# The fast-rcnn head used for context-enchanced rois.
__C.FAST_RCNN.ROI_CONTEXT_BOX_HEAD = ''
...
# Use channel-wise and spatial-wise attention 
__C.RESNETS.USE_ATTENTION = False
...
# Left-right view options, added by zhangfandong
__C.LR_VIEW = AttrDict() 
# Used for LRASY net. multiply, diff, concat
__C.LR_VIEW.DIST_POLICY = 'multiply'
__C.LR_VIEW.FUSION_POLICY = 'diff'    
__C.LR_VIEW.FUSION_NET = 'plain_333'
__C.LR_VIEW.NORM_TYPE = 'bn' 
...
# __C.DATA_DIR =r'/home1/hli/detection/maskrcnn-benchmark-master/datasets'
__C.DATA_DIR =r'/home1/hli/ori_DeepLesion'
